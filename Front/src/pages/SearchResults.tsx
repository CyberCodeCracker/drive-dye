...
import { Star, MapPin, Users, ArrowRight, Filter, Loader2, ArrowLeft, Search, Calendar } from "lucide-react";
                ...
                <CardContent className="p-5">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                      <div
                        className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center ring-2 ring-primary/20 font-bold text-primary text-lg cursor-pointer hover:ring-primary/40 transition-all"
                        onClick={(e) => { e.stopPropagation(); navigate(`/conducteur/${trajet.conducteur.id}`); }}
